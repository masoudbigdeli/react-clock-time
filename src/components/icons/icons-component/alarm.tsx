...
const AlarmIcon: React.FC<AlarmIconProps> = ({ fillColor, iconSize }) => {
    return (
      <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill={fillColor} xmlns="http://www.w3.org/2000/svg">
        <path d="M15.0195 19.0596C15.0195 20.7096 13.6695 22.0596 12.0195 22.0596C11.1995 22.0596 10.4395 21.7196 9.89953 21.1796C9.35953 20.6396 9.01953 19.8796 9.01953 19.0596" stroke="#3B3B3B" strokeWidth="1.5" strokeMiterlimit="10" />
